...
export const POIS = [
  ...
  {
    id: "boyana", name: "Боянска църква", bg: "BOYANA", tag: "ЮНЕСКО · 1979",
    lat: 42.6448, lng: 23.2663,
    cards: [
      { title: "Боянска църква", wiki: "Boyana_Church", lat: 42.64467, lng: 23.26617,
        text: "Малка средновековна църква, чиито стенописи са рисувани през 1259 г. В списъка на световното наследство на ЮНЕСКО е от 1979 г." },
      { title: "240 образа", wiki: "Boyana_Church", lat: 42.64467, lng: 23.26617,
        text: "По стените има 89 сцени с 240 човешки образа, сред най-живите портрети в средновековното изкуство на Източна Европа." },
      { title: "Черни връх", wiki: "Cherni_Vrah", lat: 42.56361, lng: 23.27833,
        text: "Църквата е в подножието на Витоша. Най-високият ѝ връх, 2290 м, е точно на юг." },
    ],
  },
  {
